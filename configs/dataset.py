...
# ============= Path ===================
dataset_root_dir = r"C:\Users\hg25079\Documents\GitHub\LaneGraph"
raw_data_path = os.path.join(dataset_root_dir, 'raw_data')
training_data_path = os.path.join(dataset_root_dir, 'training_data')
testing_data_path = os.path.join(dataset_root_dir, 'testing_data')
...
config = dict(
    paths=dict(
        ...
        training_data_path=os.path.join(dataset_root_dir, training_data_path),
        testing_data_path=os.path.join(dataset_root_dir, testing_data_path),
    ),
